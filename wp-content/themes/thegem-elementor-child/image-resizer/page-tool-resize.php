...
<div class="resizer-app">
    ...
    <header class="resizer-header">
        <a href="/" class="site-logo-link">
            ...
            <img src="<?php echo get_theme_file_uri('/image-resizer/logo.png'); ?>?v=<?php echo time(); ?>" alt="UpscaleIMG" class="resizer-logo" style="display: block; margin: 0 auto 1.5rem auto; max-width: 300px; height: auto;">
        </a>
            ...
            <div class="canvas-container" id="drop-zone">
                ...
                <div class="upload-overlay" id="upload-screen">
                    ...
                    <div style="margin-top: 2rem; color: #888; font-size: 0.9rem;">
                        ...
                        <span style="color: var(--brand-pink); margin-left: 10px; margin-right: 5px;">✔</span> Batch Processing
                    </div>
                </div>
        ...
        <aside class="controls-panel">
            ...
            <div id="smart-controls" style="display: none;">
                <div class="panel-section">
                    ...
                    <div id="color-picker-wrap" style="display: none; margin-top: 10px;">
                        <input type="color" id="bg-color-picker" value="#ffffff" style="width: 100%; height: 40px; border: 1px solid #ccc; cursor: pointer;">
                    </div>
                </div>
            </div>
            ...
            <div class="panel-section">
             ...
             <div class="panel-section">
                ...
                <div style="text-align: right; font-size: 0.8rem; color: #666; margin-top: 5px;" id="scale-val">100%</div>
            </div>
