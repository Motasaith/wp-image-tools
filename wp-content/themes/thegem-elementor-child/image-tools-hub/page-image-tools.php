...
<link rel="stylesheet" href="<?php echo $hub_url; ?>/hub-style.css?ver=<?php echo filemtime(__DIR__ . '/hub-style.css'); ?>">
...
<div class="image-hub-wrapper" style="min-height: auto; background: transparent;">
    ...
    <section class="tools-grid-section">
        <div class="hub-container">
            <div class="tools-grid">
                ...
                <!-- 1. Compress IMAGE -->
                <a href="#" class="tool-card" data-category="optimize">
                    <div class="card-header">
                        <div class="brand-icon">
                            <img src="<?php echo $hub_url; ?>/SVG/compress_img.svg" alt="Compress Image" style="width: 100%; height: 100%; object-fit: contain;">
                        </div>
                ...
                <a href="#" class="tool-card" data-category="edit">
                    <div class="card-header">
                        <div class="brand-icon">
                            <img src="<?php echo $hub_url; ?>/SVG/resize_img.svg" alt="Resize IMAGE" style="width: 100%; height: 100%; object-fit: contain;">
                        </div>
                ...
                <a href="#" class="tool-card" data-category="edit">
                     <div class="card-header">
                        <div class="brand-icon">
                            <img src="<?php echo $hub_url; ?>/SVG/crop_img.svg" alt="Crop IMAGE" style="width: 100%; height: 100%; object-fit: contain;">
                        </div>
            ...
            <!-- 4. Conversion -->
            <a href="#" class="tool-card" data-category="convert">
                <div class="card-header">
                    <div class="brand-icon">
                        <!-- Using Convert to JPG icon as the main icon for now, or a generic one if available -->
                         <img src="<?php echo $hub_url; ?>/SVG/convert_to_jpg.svg" alt="Conversion" style="width: 100%; height: 100%; object-fit: contain;">
                    </div>
                ...
                <a href="#" class="tool-card" data-category="edit">
                     <div class="card-header">
                        <div class="brand-icon">
                            <img src="<?php echo $hub_url; ?>/SVG/photo_editor.svg" alt="Photo editor" style="width: 100%; height: 100%; object-fit: contain;">
                        </div>
                ...
                <!-- 7. Upscale Image -->
                <a href="/image-upscaler" class="tool-card" data-category="optimize">
                     <div class="card-header">
                        <div class="brand-icon">
                            <img src="<?php echo $hub_url; ?>/SVG/upscale_img.svg" alt="Upscale Image" style="width: 100%; height: 100%; object-fit: contain;">
                        </div>
                 ...
                 <a href="#" class="tool-card" data-category="edit">
                     <div class="card-header">
                        <div class="brand-icon">
                            <img src="<?php echo $hub_url; ?>/SVG/remove_background.svg" alt="Remove background" style="width: 100%; height: 100%; object-fit: contain;">
                        </div>
                ...
                <!-- 10. Remove Watermark -->
                 ...
                 <!-- 11. Meme generator -->
                 <a href="#" class="tool-card" data-category="create">
                     <div class="card-header">
                        <div class="brand-icon">
                            <img src="<?php echo $hub_url; ?>/SVG/meme_generator.svg" alt="Meme generator" style="width: 100%; height: 100%; object-fit: contain;">
                        </div>
                        <h3 class="card-title">Meme generator</h3>
                     </div>
                    <p class="card-desc">Create your memes online with ease.</p>
                 ...
                 <a href="#" class="tool-card" data-category="convert">
                    <div class="card-header">
                        <div class="brand-icon">
                            <img src="<?php echo $hub_url; ?>/SVG/html_to_img.svg" alt="HTML to IMAGE" style="width: 100%; height: 100%; object-fit: contain;">
                        </div>
    ...
    .comp-title { font-size: 1.25rem; font-weight: 700; margin: 0 0 0.5rem 0; color: #1a1a1a; }
    .comp-desc { font-size: 0.95rem; color: #666; line-height: 1.5; margin: 0; }
    ...
    .label-left { left: 1rem; }  /* Original */
    .label-right { right: 1rem; } /* Processed */
    </style>

    <section class="comparison-section">
        <div class="comp-container">
            <div class="comp-title-area text-center mb-5">
                <h2 style="font-size: 2.5rem; font-weight: 800; margin-bottom: 1rem; color: #1a1a1a;">See the magic in action</h2>
                <p style="color: #666; max-width: 600px; margin: 0 auto 3rem auto;">Transform your images instantly with our AI-powered tools.</p>
            </div>
            ...
            <div class="comp-grid">
                ...
                <div class="comp-card">
                    <div class="comp-visual" onmousemove="updateSlider(event, this)" ontouchmove="updateSlider(event, this)">
                        
                        <!-- Base: Processed (Right) -->
                        <!-- We use the user uploaded processed image here -->
                        <img src="<?php echo get_stylesheet_directory_uri(); ?>/image-tools-hub/images/rem-bg-processed.png" class="comp-right-processed" alt="Removed BG">
                        
                        <!-- Top: Original (Left) -->
                        <div class="comp-left-original">
                             <!-- We use the user uploaded original image here -->
                             <img src="<?php echo get_stylesheet_directory_uri(); ?>/image-tools-hub/images/rem-bg-original.png" class="comp-img-fixed" alt="Original">
                        </div>
                    ...
                    <div class="comp-content">
                        ...
                        <p class="comp-desc">Create professional product photos with clean backgrounds for online stores.</p>
                    </div>
                </div>
                ...
                <div class="comp-card">
                    <div class="comp-visual" onmousemove="updateSlider(event, this)" ontouchmove="updateSlider(event, this)">
                        <!-- Base: Enhanced -->
                        <img src="<?php echo get_stylesheet_directory_uri(); ?>/image-tools-hub/images/faceenhancer_processed.jpeg" class="comp-right-processed" alt="Enhanced">

                        <!-- Top: Original/Blurry -->
                        <div class="comp-left-original">
                             <img src="<?php echo get_stylesheet_directory_uri(); ?>/image-tools-hub/images/faceenhancer_original.jpg" class="comp-img-fixed" alt="Blurry">
                        </div>
                    ...
                    <div class="comp-content">
                        ...
                        <p class="comp-desc">Sharpen details and enhance faces perfectly with our <a href="#">face enhancer</a>.</p>
                    </div>
                </div>
                ...
                <div class="comp-card">
                    <div class="comp-visual" onmousemove="updateSlider(event, this)" ontouchmove="updateSlider(event, this)">
                        <!-- Base: Upscaled -->
                        <img src="<?php echo get_stylesheet_directory_uri(); ?>/image-tools-hub/images/upscaler_processed.png" class="comp-right-processed" alt="Upscaled">

                        <!-- Top: Low Res -->
                        <div class="comp-left-original">
                             <img src="<?php echo get_stylesheet_directory_uri(); ?>/image-tools-hub/images/upscaler_original.png" class="comp-img-fixed" alt="Low Res">
                        </div>
